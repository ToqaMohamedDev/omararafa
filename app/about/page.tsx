        ...
        >
          ...
          >
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
              ...
              دروس متخصصة في النحو والصرف والبلاغة والأدب.
            </p>
            <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
              تحت إشراف الأستاذ عمر عرفه، مدرس لغة عربية أزهري بخبرة تزيد عن 7
          ...
          >
            ...
            >
              {[
                "مدرس لغة عربية أزهري بخبرة تزيد عن 7 سنوات في تدريس اللغة العربية بجميع فروعها. متخصص في النحو والصرف والبلاغة والإعراب.",
                "حاصل على درجة علمية من الأزهر الشريف، مع شهادات في طرق التدريس الحديثة وخبرة واسعة في التعليم الإلكتروني.",
